<html>
    ...
    <style>
     body, html{
        background-image:	linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)), url(../admin/images/background.jpg);
          ...
          <div class="card-body">
            ...
            <form class="form-signin"  action="log.php" method="POST">
              <div class="form-label-group">
                <input type="email" name="s_email" id="s_email" class="form-control" placeholder="E-mail" required>
              </div>
